...
public class manageinstructor extends javax.swing.JFrame {
    ...
    public manageinstructor() {
        ...
        ins.fillInstructorJtable(jTable, "");
    }
    ...
    private void initComponents() {
        ...
        subject.setFont(new java.awt.Font("Comic Sans MS", 0, 12)); // NOI18N
        ...
        jTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Name", "Email", "Subject", "Lab", "Faculty"
            }
        ));
        ...
        lab.setFont(new java.awt.Font("Comic Sans MS", 0, 12)); // NOI18N
    ...
    public boolean verifText(){
        if(id.getText().equals("") || name.getText().equals("") || email.getText().equals("") || subject.getText().equals("") || lab.getText().equals(""))
        {
    ...
    private void jButtonEditteacherActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEditteacherActionPerformed
        ...
        if(verifText()){
            ...
            in.insertUpdateDeleteinstructor('u', Id, Name, Email, Subject, Lab, faculty);
//            MainForm.jLabel_instructor.setText("Instructors = "+Integer.toString( MyFunction.countData("instructor")));
            manageinstructor.jTable.setModel(new DefaultTableModel(null, new Object[]{"ID","Name","Email","Subject","Lab","Faculty"}));
            ins.fillInstructorJtable(manageinstructor.jTable, "");
        }
    ...
    private void jButtonPGRemoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPGRemoveActionPerformed
        ...
        {
            JOptionPane.showMessageDialog(null, "Select a Instructor");
        }else{
        String Id = String.valueOf(id.getText());
        ins.insertUpdateDeleteinstructor('d', Id, null, null, null, null, null);
        manageinstructor.jTable.setModel(new DefaultTableModel(null, new Object[]{"ID","Name","Email","Subject","Faculty"}));
        ins.fillInstructorJtable(manageinstructor.jTable, "");
        }
    ...
    private void jTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableMouseClicked
        ...
        if(model.getValueAt(rowIndex, 5).toString().equals("SOC"))
        {
            soc.setSelected(true);
            soe.setSelected(false);
            som.setSelected(false);
        }
        else if(model.getValueAt(rowIndex, 5).toString().equals("SOE"))
        {
            soc.setSelected(false);
            soe.setSelected(true);
            som.setSelected(false);
        }
        else if(model.getValueAt(rowIndex, 5).toString().equals("SOM"))
        {
            soc.setSelected(false);
            soe.setSelected(false);
        ...
        subject.setText(model.getValueAt(rowIndex, 3).toString());
        lab.setText(model.getValueAt(rowIndex, 4).toString());
    ...
    private void valtofinedKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_valtofinedKeyReleased
        jTable.setModel(new DefaultTableModel(null, new Object[]{"ID","Name","Email","Subject","Lab","Faculty"}));
        ins.fillInstructorJtable(jTable, valtofined.getText());
