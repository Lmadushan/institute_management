 ...
 */
public class Sendres extends javax.swing.JFrame {

    /**
     * Creates new form Sendres
     */
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Send UG Result");
    ...
    private void jTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableMouseClicked
        ...
        index.setText(model1.getValueAt(rowIndex, 0).toString());
        name.setText(model1.getValueAt(rowIndex, 1).toString());
        email.setText(model1.getValueAt(rowIndex, 2).toString());
    ...
    private void valtofinedKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_valtofinedKeyReleased
        ...
        res.fillIndexJtable(jTable, valtofined.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Sendres.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
