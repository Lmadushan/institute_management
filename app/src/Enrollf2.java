 ...
 */
public class Enrollf2 extends javax.swing.JFrame {

    /**
     * Creates new form Enrollf2
     */
    enroll2 en = new enroll2();
    public Enrollf2() {
        initComponents();
        en.fillEnroll2Jtable(jTable, "");
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Enroll Student Sem2");
    ...
    private void jButtonEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEditActionPerformed
        ...
        if(verifText()){
            enroll2 sub = new enroll2();
            sub.insertUpdateDeleteenroll2('u', ID, S1, S2, S3, S4, S5, S6);
            //            MainForm.jLabel_instructor.setText("Subject = "+Integer.toString( MyFunction.countData("subject")));
            Enrollf2.jTable.setModel(new DefaultTableModel(null, new Object[]{"ID","SUB1","SUB2","SUB3","SUB4","SUB5","SUB6"}));
            sub.fillEnroll2Jtable(Enrollf2.jTable, "");
        }
    ...
    private void jButtonPGRemoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPGRemoveActionPerformed
        ...
        en.insertUpdateDeleteenroll2('d', Id, null, null, null, null, null, null);
        Enrollf2.jTable.setModel(new DefaultTableModel(null, new Object[]{"ID","Sub1","Sub2","Sub3","Sub4","Sub5","Sub6"}));
        en.fillEnroll2Jtable(Enrollf2.jTable, "");
        }
    ...
    private void valtofinedKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_valtofinedKeyReleased
        ...
        en.fillEnroll2Jtable(jTable, valtofined.getText());
    ...
    private void jButtonAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAddActionPerformed
        ...
        if(verifText()){
            enroll2 subj = new enroll2();
            subj.insertUpdateDeleteenroll2('i', ID,S1,S2,S3,S4,S5,S6);
            //            MainForm.jLabel_instructor.setText("Subject = "+Integer.toString( MyFunction.countData("subject")));

            Enrollf2.jTable.setModel(new DefaultTableModel(null, new Object[]{"ID","Sub1","Sub2","Sub3","Sub4","Sub5","Sub6"}));
            subj.fillEnroll2Jtable(Enrollf2.jTable, "");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Enrollf2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
